...
const addons = [
  {
    ...
    desc: "Guests tap a button on the table QR to instantly notify staff.",
    to: "/addons/waiter-calling",
  },
  {
    icon: QrCode,
    title: "QR Scan & Pay",
    desc: "Customers scan, pay via UPI and settle their bill in seconds.",
    to: "/addons/qr-pay",
  },
  {
    icon: MessageSquare,
    title: "SMS Marketing",
    desc: "Send offers, festival greetings and reorder reminders to your CRM.",
    to: "/addons/sms-marketing",
  },
  {
    icon: Star,
    title: "Customer Feedback",
    desc: "Capture star ratings and reviews automatically after every meal.",
    to: "/addons/feedback",
  },
];
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {addons.map((a) => (
          ...
          >
            <Card className="relative h-full overflow-hidden border-border/50 transition-all group-hover:-translate-y-1 group-hover:border-primary/40 group-hover:shadow-lg">
