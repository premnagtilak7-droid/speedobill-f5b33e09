            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full h-12 rounded-xl border border-border bg-white dark:bg-secondary flex items-center justify-center gap-3 text-sm font-medium text-foreground hover:bg-gray-50 dark:hover:bg-secondary/80 transition-colors disabled:opacity-50"
                >
                  {googleLoading ? (
